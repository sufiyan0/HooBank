  ...
  <section id='home' className={`flex md:flex-row flex-col  ${styles.paddingY}`} >
    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:p-16 px-6 `}>
      ...
      <div className="flex  flex-row items-center justify-between ">
        <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] xs:text-[52px] text-[40px] text-white ss:leading-[100px] leading-[75px]'>
          THE NEXT <br className='hidden sm:block w-full'/>
          <span className='text-gradient'>GENERATION</span>
        </h1>

        <div className="hidden ss:flex md:mr-4 mr-0 mx-16 mb-16">
          <GetStarted />
        </div>
      </div>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mb-6`}>
